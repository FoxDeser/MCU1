...
/*************************Check for TC flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->SR & ( 1 << USART_SR_TC_Pos);
...
//Note : CTS feature is not applicable for UART4 and UART5
	...
	temp1 = pUSARTHandle->pUSARTx->SR & ( 1 << USART_SR_CTS_Pos);
...
//	temp3 = pUSARTHandle->pUSARTx->CR3 & ( 1 << USART_CR3_CTSIE_Pos);
	...
	if(temp1  && temp2 )
	{
		...
		pUSARTHandle->pUSARTx->SR &= ~( 1 << USART_CR1_TXEIE_Pos);
...
/*************************Check for IDLE detection flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->SR & ( 1 << USART_SR_IDLE_Pos);
	
	//Implement the code to check the state of IDLEIE bit in CR1
	temp2 = pUSARTHandle->pUSARTx->CR1 & ( 1 << USART_SR_IDLE_Pos);
...
/*************************Check for Overrun detection flag ********************************************/
	...
	temp1 = pUSARTHandle->pUSARTx->SR & USART_SR_ORE_Pos;
	
	//Implement the code to check the status of RXNEIE  bit in the CR1
	temp2 = pUSARTHandle->pUSARTx->CR1 & USART_CR1_RXNEIE_Pos;
...
//The blow code will get executed in only if multibuffer mode is used. 
	...
	temp2 =  pUSARTHandle->pUSARTx->CR3 & ( 1 << USART_CR3_EIE_Pos) ;

	if(temp2 )
	{
		temp1 = pUSARTHandle->pUSARTx->SR;
		if(temp1 & ( 1 << USART_SR_FE_Pos))
		{
			/*
		...
		if(temp1 & ( 1 << USART_SR_PE_Pos) )
		{
			/*
				...
				USART_DR register).
			*/
			USART_ApplicationEventCallback(pUSARTHandle,USART_ERREVENT_PE);
		}

		if(temp1 & ( 1 << USART_SR_ORE_Pos) )
		{
